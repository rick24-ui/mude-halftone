  ...
  return (
    <label className="flex items-center justify-between gap-2">
      ...
      <input
        ...
        className="w-24 rounded bg-[var(--panel-2)] px-2 py-1.5 text-right text-[12px] outline-none focus:ring-1 focus:ring-red"
      />
    </label>
  );
}
  ...
  return (
    <label className="flex items-center justify-between gap-2">
      ...
      <input
        ...
        className="min-w-0 flex-1 rounded bg-[var(--panel-2)] px-2 py-1.5 text-right text-[12px] outline-none focus:ring-1 focus:ring-red"
      />
    </label>
  );
}
      ...
      <div className="flex flex-1 items-center justify-center overflow-hidden bg-ink p-6">
        ...
        >
          ...
          <div className="absolute inset-0 flex items-center justify-center">
            <span className="label rounded bg-black/40 px-3 py-1.5 backdrop-blur">prévia do conteúdo</span>
          </div>
      ...
      <aside className="flex w-[330px] shrink-0 flex-col border-l border-line bg-[var(--panel)]">
            ...
            <div className="grid grid-cols-2 gap-1.5">
              {FORMAT_PRESETS.map((f) => (
                <button
                  ...
                  className={`rounded border px-2 py-1.5 text-left text-[10px] leading-tight transition-colors ${
        ...
        <div className="border-t border-line bg-[var(--panel)] px-4 py-4">
          ...
          <div className="grid grid-cols-2 gap-2">
            ...
            <button onClick={exportSVG} className="rounded bg-red py-2.5 text-xs font-medium text-white hover:opacity-90">
              SVG
            </button>
          </div>
        </div>
